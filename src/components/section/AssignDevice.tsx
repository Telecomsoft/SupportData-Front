...
const AssignDevice: FunctionComponent<GeneralInfoProps> = ({ infoOptions, height }) => {
                ...
                <>
                    {updateDevice?.map((i: { itemKind: string; settingName: string }) => (
                        <Grid
                            ...
                            size={6}
                            sx={{
                                py: i?.itemKind !== 'Bool' ? sizeConverter(6, 'spaceY') : 0,
